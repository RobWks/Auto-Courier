...
""""
Shortest Path
Script to calculate waypoints of shortest path using Dijkstra's algorithm.

Input: Graph.npy, a graph of travel options through the environment
Output: nodes.npy and path.npy, coordinates of nodes and the order of nodes along shortest path.
"""
