...
""""
Choose Room
Publisher script to publish navigation goal.

Input: e5.csv, a directory of the third floor of e5.
Output: Published goal pose
"""
...
def talker():
	file_loc = '/home/rob/Auto-Courier/Map/Directory/e5.csv'
